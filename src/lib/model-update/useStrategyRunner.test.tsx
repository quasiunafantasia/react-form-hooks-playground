...
describe('UseUpdateStrategyRunner', () => {
    ...
    // @ts-ignore
    const TestComponent = ({firstValue, secondValue, callback, usedStrategy}) => {
    ...
    beforeEach(() => {
        ...
        wrapper = mount(<TestComponent firstValue={0} callback={callback} secondValue={0} usedStrategy={0}/>);
    });
